...
################################################################
# This is a generated script based on design: Complet
#
...
# source Complet_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, gzip_compressor_top, FIFO_stream, FIFO_stream, FIFO_stream, FIFO_stream, SpW_gen, SpW_gen, SpW_gen, SpW_gen, Instruments_starter
...
\
  ...
  # Create instance: rst_ps8_0_10M, and set properties
  set rst_ps8_0_10M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_10M ]
  ...
  # Create instance: gzip_compressor_top_0, and set properties
  set block_name gzip_compressor_top
  set block_cell_name gzip_compressor_top_0
  if { [catch {set gzip_compressor_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gzip_compressor_top_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property CONFIG.NUM_SI {1} $axi_smc_4
  ...
  set_property CONFIG.NUM_SI {1} $axi_smc_5
  ...
  if { [catch {set FIFO_stream_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    CONFIG.NUMBER_OF_OUTPUT_WORDS {8} \
  ] $FIFO_stream_0
  ...
  # Create instance: Instruments_starter_0, and set properties
  set block_name Instruments_starter
  set block_cell_name Instruments_starter_0
  if { [catch {set Instruments_starter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Instruments_starter_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_S2MM [get_bd_intf_pins axi_dma_1/M_AXI_S2MM] [get_bd_intf_pins axi_smc_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_S2MM [get_bd_intf_pins axi_dma_3/M_AXI_S2MM] [get_bd_intf_pins axi_smc_3/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_4_M_AXI_S2MM [get_bd_intf_pins axi_dma_4/M_AXI_S2MM] [get_bd_intf_pins axi_smc_4/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_5_M_AXIS_MM2S [get_bd_intf_pins axi_dma_5/M_AXIS_MM2S] [get_bd_intf_pins gzip_compressor_top_0/i]
  connect_bd_intf_net -intf_net axi_dma_5_M_AXI_MM2S [get_bd_intf_pins axi_dma_5/M_AXI_MM2S] [get_bd_intf_pins axi_smc_5/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_4_M00_AXI [get_bd_intf_pins axi_smc_4/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net axi_smc_5_M00_AXI [get_bd_intf_pins axi_smc_5/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC1_FPD]
  ...
  connect_bd_intf_net -intf_net gzip_compressor_top_0_o [get_bd_intf_pins gzip_compressor_top_0/o] [get_bd_intf_pins axi_dma_4/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_dma_2/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_dma_3/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_dma_4/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins axi_dma_5/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins ps8_0_axi_periph/M06_AXI] [get_bd_intf_pins Instruments_starter_0/S_AXI]
  ...
  connect_bd_net -net Instruments_starter_0_start_0 [get_bd_pins Instruments_starter_0/start_0] [get_bd_pins SpW_gen_0/start]
  connect_bd_net -net Instruments_starter_0_start_1 [get_bd_pins Instruments_starter_0/start_1] [get_bd_pins SpW_gen_1/start]
  connect_bd_net -net Instruments_starter_0_start_2 [get_bd_pins Instruments_starter_0/start_2] [get_bd_pins SpW_gen_2/start]
  connect_bd_net -net Instruments_starter_0_start_3 [get_bd_pins Instruments_starter_0/start_3] [get_bd_pins SpW_gen_3/start]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_0/Clk] [get_bd_pins spwr_ip_1/Clk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_2/Clk] [get_bd_pins spwr_ip_3/Clk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_4/Clk] [get_bd_pins spwr_ip_5/Clk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_dma_3/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_6/Clk] [get_bd_pins spwr_ip_7/Clk] [get_bd_pins rst_ps8_0_10M/slowest_sync_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins axi_smc_2/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins axi_smc_3/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk] [get_bd_pins gzip_compressor_top_0/clk] [get_bd_pins axi_dma_4/m_axi_s2mm_aclk] [get_bd_pins axi_smc_4/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins axi_dma_4/s_axi_lite_aclk] [get_bd_pins axi_dma_5/m_axi_mm2s_aclk] [get_bd_pins axi_smc_5/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc1_fpd_aclk] [get_bd_pins axi_dma_5/s_axi_lite_aclk] [get_bd_pins FIFO_stream_0/clk] [get_bd_pins FIFO_stream_1/clk] [get_bd_pins FIFO_stream_2/clk] [get_bd_pins FIFO_stream_3/clk] [get_bd_pins SpW_gen_0/Clk] [get_bd_pins SpW_gen_1/Clk] [get_bd_pins SpW_gen_2/Clk] [get_bd_pins SpW_gen_3/Clk] [get_bd_pins Instruments_starter_0/Clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK]
  connect_bd_net -net rst_ps8_0_10M_peripheral_aresetn [get_bd_pins rst_ps8_0_10M/peripheral_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axi_smc_2/aresetn] [get_bd_pins axi_smc_3/aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins spwr_ip_0/Reset_n] [get_bd_pins spwr_ip_1/Reset_n] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins spwr_ip_2/Reset_n] [get_bd_pins spwr_ip_3/Reset_n] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins spwr_ip_4/Reset_n] [get_bd_pins spwr_ip_5/Reset_n] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins spwr_ip_6/Reset_n] [get_bd_pins spwr_ip_7/Reset_n] [get_bd_pins gzip_compressor_top_0/rstn] [get_bd_pins axi_smc_4/aresetn] [get_bd_pins axi_dma_4/axi_resetn] [get_bd_pins axi_smc_5/aresetn] [get_bd_pins axi_dma_5/axi_resetn] [get_bd_pins FIFO_stream_0/reset_n] [get_bd_pins FIFO_stream_1/reset_n] [get_bd_pins FIFO_stream_2/reset_n] [get_bd_pins FIFO_stream_3/reset_n] [get_bd_pins SpW_gen_0/Reset_n] [get_bd_pins SpW_gen_1/Reset_n] [get_bd_pins SpW_gen_2/Reset_n] [get_bd_pins SpW_gen_3/Reset_n] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins Instruments_starter_0/Reset_n]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_10M/ext_reset_in]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Instruments_starter_0/S_AXI/reg0] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_4/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_5/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_2/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_3/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_3/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_QSPI] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_5/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_5/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_QSPI] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_3/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_5/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM]
