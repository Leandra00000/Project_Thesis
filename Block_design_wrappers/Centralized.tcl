...
\
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_S2MM [get_bd_intf_pins axi_dma_1/M_AXI_S2MM] [get_bd_intf_pins axi_smc_2/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_S2MM [get_bd_intf_pins axi_dma_2/M_AXI_S2MM] [get_bd_intf_pins axi_smc_3/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_S2MM [get_bd_intf_pins axi_dma_3/M_AXI_S2MM] [get_bd_intf_pins axi_smc_4/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_4_M_AXIS_MM2S [get_bd_intf_pins axi_dma_4/M_AXIS_MM2S] [get_bd_intf_pins gzip_compressor_top_0/i]
  connect_bd_intf_net -intf_net axi_dma_4_M_AXI_MM2S [get_bd_intf_pins axi_dma_4/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_4_M_AXI_S2MM [get_bd_intf_pins axi_dma_4/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins axi_dma_4/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_dma_2/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_dma_3/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins Instruments_starter_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_0/Clk] [get_bd_pins spwr_ip_1/Clk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_2/Clk] [get_bd_pins spwr_ip_3/Clk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_4/Clk] [get_bd_pins spwr_ip_5/Clk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_dma_3/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_6/Clk] [get_bd_pins spwr_ip_7/Clk] [get_bd_pins rst_ps8_0_10M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk] [get_bd_pins gzip_compressor_top_0/clk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins Instruments_starter_0/Clk] [get_bd_pins SpW_gen_0/Clk] [get_bd_pins SpW_gen_1/Clk] [get_bd_pins SpW_gen_2/Clk] [get_bd_pins SpW_gen_3/Clk] [get_bd_pins FIFO_stream_0/clk] [get_bd_pins FIFO_stream_1/clk] [get_bd_pins FIFO_stream_2/clk] [get_bd_pins FIFO_stream_3/clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins axi_smc_1/aclk] [get_bd_pins axi_smc_2/aclk] [get_bd_pins axi_smc_3/aclk] [get_bd_pins axi_smc_4/aclk] [get_bd_pins axi_dma_4/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_dma_4/m_axi_mm2s_aclk] [get_bd_pins axi_dma_4/m_axi_s2mm_aclk]
  connect_bd_net -net rst_ps8_0_10M_peripheral_aresetn [get_bd_pins rst_ps8_0_10M/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins spwr_ip_0/Reset_n] [get_bd_pins spwr_ip_1/Reset_n] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins spwr_ip_2/Reset_n] [get_bd_pins spwr_ip_3/Reset_n] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins spwr_ip_4/Reset_n] [get_bd_pins spwr_ip_5/Reset_n] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins spwr_ip_6/Reset_n] [get_bd_pins spwr_ip_7/Reset_n] [get_bd_pins gzip_compressor_top_0/rstn] [get_bd_pins Instruments_starter_0/Reset_n] [get_bd_pins SpW_gen_0/Reset_n] [get_bd_pins SpW_gen_1/Reset_n] [get_bd_pins SpW_gen_2/Reset_n] [get_bd_pins SpW_gen_3/Reset_n] [get_bd_pins FIFO_stream_0/reset_n] [get_bd_pins FIFO_stream_1/reset_n] [get_bd_pins FIFO_stream_2/reset_n] [get_bd_pins FIFO_stream_3/reset_n] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axi_smc_2/aresetn] [get_bd_pins axi_smc_3/aresetn] [get_bd_pins axi_smc_4/aresetn] [get_bd_pins axi_dma_4/axi_resetn] [get_bd_pins axi_smc/aresetn]
