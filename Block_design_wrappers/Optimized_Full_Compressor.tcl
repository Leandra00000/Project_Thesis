...
################################################################
# This is a generated script based on design: Optimized_Full_Compressor
#
...
# source Optimized_Full_Compressor_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, spwr_ip, gzip_compressor_top, gzip_compressor_top, gzip_compressor_top, gzip_compressor_top, FIFO_stream, FIFO_stream, FIFO_stream, FIFO_stream, SpW_gen, SpW_gen, SpW_gen, SpW_gen, Instruments_starter
...
set design_name Optimized_Full_Compressor
...
\
  ...
  # Create instance: gzip_compressor_top_1, and set properties
  set block_name gzip_compressor_top
  set block_cell_name gzip_compressor_top_1
  if { [catch {set gzip_compressor_top_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gzip_compressor_top_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: gzip_compressor_top_2, and set properties
  set block_name gzip_compressor_top
  set block_cell_name gzip_compressor_top_2
  if { [catch {set gzip_compressor_top_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gzip_compressor_top_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: gzip_compressor_top_3, and set properties
  set block_name gzip_compressor_top
  set block_cell_name gzip_compressor_top_3
  if { [catch {set gzip_compressor_top_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gzip_compressor_top_3 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set FIFO_stream_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [list \
    CONFIG.C_M_AXIS_TDATA_WIDTH {8} \
    CONFIG.FIFO_DEPTH {2048} \
    CONFIG.NUMBER_OF_OUTPUT_WORDS {1024} \
  ] $FIFO_stream_0
  ...
  connect_bd_intf_net -intf_net FIFO_stream_0_M_AXIS [get_bd_intf_pins FIFO_stream_0/M_AXIS] [get_bd_intf_pins gzip_compressor_top_0/i]
  connect_bd_intf_net -intf_net FIFO_stream_1_M_AXIS [get_bd_intf_pins gzip_compressor_top_1/i] [get_bd_intf_pins FIFO_stream_1/M_AXIS]
  connect_bd_intf_net -intf_net FIFO_stream_2_M_AXIS [get_bd_intf_pins FIFO_stream_2/M_AXIS] [get_bd_intf_pins gzip_compressor_top_2/i]
  connect_bd_intf_net -intf_net FIFO_stream_3_M_AXIS [get_bd_intf_pins FIFO_stream_3/M_AXIS] [get_bd_intf_pins gzip_compressor_top_3/i]
  ...
  connect_bd_intf_net -intf_net gzip_compressor_top_0_o [get_bd_intf_pins gzip_compressor_top_0/o] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net gzip_compressor_top_1_o [get_bd_intf_pins gzip_compressor_top_1/o] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net gzip_compressor_top_2_o [get_bd_intf_pins gzip_compressor_top_2/o] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net gzip_compressor_top_3_o [get_bd_intf_pins gzip_compressor_top_3/o] [get_bd_intf_pins axi_dma_3/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins Instruments_starter_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_0/Clk] [get_bd_pins spwr_ip_1/Clk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_2/Clk] [get_bd_pins spwr_ip_3/Clk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_4/Clk] [get_bd_pins spwr_ip_5/Clk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_dma_3/m_axi_s2mm_aclk] [get_bd_pins spwr_ip_6/Clk] [get_bd_pins spwr_ip_7/Clk] [get_bd_pins axi_smc/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins axi_smc_2/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins axi_smc_3/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk] [get_bd_pins gzip_compressor_top_0/clk] [get_bd_pins rst_ps8_0_10M/slowest_sync_clk] [get_bd_pins gzip_compressor_top_1/clk] [get_bd_pins gzip_compressor_top_2/clk] [get_bd_pins gzip_compressor_top_3/clk] [get_bd_pins FIFO_stream_0/clk] [get_bd_pins FIFO_stream_1/clk] [get_bd_pins FIFO_stream_2/clk] [get_bd_pins FIFO_stream_3/clk] [get_bd_pins SpW_gen_0/Clk] [get_bd_pins SpW_gen_1/Clk] [get_bd_pins SpW_gen_2/Clk] [get_bd_pins SpW_gen_3/Clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins Instruments_starter_0/Clk] [get_bd_pins ps8_0_axi_periph/M04_ACLK]
  connect_bd_net -net rst_ps8_0_10M_peripheral_aresetn1 [get_bd_pins rst_ps8_0_10M/peripheral_aresetn] [get_bd_pins gzip_compressor_top_0/rstn] [get_bd_pins gzip_compressor_top_1/rstn] [get_bd_pins gzip_compressor_top_2/rstn] [get_bd_pins gzip_compressor_top_3/rstn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axi_smc_2/aresetn] [get_bd_pins axi_smc_3/aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins spwr_ip_0/Reset_n] [get_bd_pins spwr_ip_1/Reset_n] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins spwr_ip_2/Reset_n] [get_bd_pins spwr_ip_3/Reset_n] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins spwr_ip_4/Reset_n] [get_bd_pins spwr_ip_5/Reset_n] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins spwr_ip_6/Reset_n] [get_bd_pins spwr_ip_7/Reset_n] [get_bd_pins FIFO_stream_0/reset_n] [get_bd_pins FIFO_stream_1/reset_n] [get_bd_pins FIFO_stream_2/reset_n] [get_bd_pins FIFO_stream_3/reset_n] [get_bd_pins SpW_gen_0/Reset_n] [get_bd_pins SpW_gen_1/Reset_n] [get_bd_pins SpW_gen_2/Reset_n] [get_bd_pins SpW_gen_3/Reset_n] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN]
